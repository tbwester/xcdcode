...
run, spem, spemErr, spes, occ, occErr, fitm = loadtxt('caliblog.txt', unpack=True, skiprows=1)
...
ax.text(0.50, 0.25, textfit, color='black', transform=ax.transAxes, 
